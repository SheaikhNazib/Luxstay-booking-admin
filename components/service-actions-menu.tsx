...
export function ServiceActionsMenu({ serviceId }: ServiceActionsMenuProps) {
      ...
      {open
        ? createPortal(
            <div className="admin-action-dropdown" ref={menuRef} role="menu" style={position}>
              <Link className="admin-action-item" href={`/services/${serviceId}`} role="menuitem">
                <Eye size={14} />
                <span>View</span>
              </Link>

              <Link className="admin-action-item" href={`/services/${serviceId}/edit`} role="menuitem">
                <Pencil size={14} />
                <span>Edit</span>
              </Link>
